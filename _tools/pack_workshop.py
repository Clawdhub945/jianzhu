#!/usr/bin/env python3
# 组装/刷新创意工坊包：workshop/JianZhu/{About,Defs,Assemblies}
...
def main():
    ...
    # 3) About.xml 的 modVersion 与 Plugin.cs 同步
    ...
    print(f"workshop 包已刷新: Assemblies/JianZhu.dll, Defs/*.json, modVersion={ver}")
